<!DOCTYPE html>
  ...
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('css/calendarioStyles.css') }} ">
      ...
      <header>
        <nav>
          ...
          <ul class="nav-menu">
            ...
            <li><a href="entrenamiento.blade.php">ENTRENAMIENTO</a></li>
            <li><a class="activo"href="calendario.blade.php">CALENDARIO</a></li>
            <li><a href="entrenadores.blade.php">ENTRENADORES</a></li>
        ...
        <div class="perfil-caja">
          <div class="perfil-texto">
              <h1 >DETALLES DE ENTRENAMIENTO</h1>
