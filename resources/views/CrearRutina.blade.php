...
<head>
	...
	<link rel="stylesheet" type="text/css" href="CrearRutina.css">
	...
	<script defer src="CrearRutina.js"></script>
	...
	<nav class="Menu">
		...
		<ul class="Menu__ul">
			<li class="Menu__ul-li">
					...
					<a href="#" class="Menu__ul-li-a">Inicio</a>
			</li>
			<li class="Menu__ul-li">
					<i class="fas fa-dumbbell"></i>
					<a href="#" class="Menu__ul-li-a">Mis Rutinas</a>
			</li>
			<li class="Menu__ul-li">
					<i class="fas fa-calendar-alt"></i>
					<a href="#" class="Menu__ul-li-a">Crear Rutinas</a>
			</li>
			<li class="Menu__ul-li">
